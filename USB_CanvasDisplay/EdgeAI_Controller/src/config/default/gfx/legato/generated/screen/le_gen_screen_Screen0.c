...
leLabelWidget* Screen0_infoLabel;
...
leResult screenShow_Screen0(void)
{
    ...
    // layer 1
    root1 = leWidget_New();
    root1->fn->setSize(root1, 600, 480);
    ...
    // layer 2
    root2 = leWidget_New();
    root2->fn->setSize(root2, 200, 180);
    ...
    Screen0_infoLabel = leLabelWidget_New();
    Screen0_infoLabel->fn->setPosition(Screen0_infoLabel, 0, 0);
    Screen0_infoLabel->fn->setSize(Screen0_infoLabel, 169, 40);
    Screen0_infoLabel->fn->setScheme(Screen0_infoLabel, &BlueScheme);
    Screen0_infoLabel->fn->setBackgroundType(Screen0_infoLabel, LE_WIDGET_BACKGROUND_NONE);
    Screen0_infoLabel->fn->setString(Screen0_infoLabel, (leString*)&string_Smart);
    root2->fn->addChild(root2, (leWidget*)Screen0_infoLabel);
