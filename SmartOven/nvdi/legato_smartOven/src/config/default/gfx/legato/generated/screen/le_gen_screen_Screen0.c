...
leWidget* Screen0_setingButtonsPanel;
...
leButtonWidget* Screen0_wifiBackButton;
...
leButtonWidget* Screen0_CommaKeyButton;
...
leResult screenShow_Screen0(void)
{
    ...
    Screen0_SplashBasePanel->fn->setSize(Screen0_SplashBasePanel, 1280, 800);
    Screen0_SplashBasePanel->fn->setScheme(Screen0_SplashBasePanel, &BlackScheme);
    ...
    // layer 1
    root1 = leWidget_New();
    root1->fn->setSize(root1, 525, 121);
    ...
    // layer 2
    root2 = leWidget_New();
    root2->fn->setSize(root2, 1280, 800);
    ...
    Screen0_HomePanel->fn->setSize(Screen0_HomePanel, 1280, 800);
    ...
    Screen0_HomeCardImage->fn->setSize(Screen0_HomeCardImage, 1280, 676);
    ...
    Screen0_HomeCardImage->fn->setImage(Screen0_HomeCardImage, (leImage*)&RoundedGrayBG);
    root2->fn->addChild(root2, (leWidget*)Screen0_HomeCardImage);

    Screen0_logoImage = leImageWidget_New();
    Screen0_logoImage->fn->setPosition(Screen0_logoImage, 32, 24);
    Screen0_logoImage->fn->setSize(Screen0_logoImage, 48, 40);
    ...
    Screen0_logoImage->fn->setImage(Screen0_logoImage, (leImage*)&mchpLogoSm);
    root2->fn->addChild(root2, (leWidget*)Screen0_logoImage);

    Screen0_securityImage = leImageWidget_New();
    Screen0_securityImage->fn->setPosition(Screen0_securityImage, 1003, 31);
    ...
    Screen0_TimeLabel->fn->setPosition(Screen0_TimeLabel, 1059, 31);
    Screen0_TimeLabel->fn->setScheme(Screen0_TimeLabel, &WhiteScheme);
    ...
    Screen0_TempLabel->fn->setPosition(Screen0_TempLabel, 1178, 31);
    Screen0_TempLabel->fn->setScheme(Screen0_TempLabel, &WhiteScheme);
    ...
    Screen0_HomeGlowImage->fn->setSize(Screen0_HomeGlowImage, 651, 346);
    ...
    Screen0_HomeGlowImage->fn->setImage(Screen0_HomeGlowImage, (leImage*)&bGlow);
    root2->fn->addChild(root2, (leWidget*)Screen0_HomeGlowImage);

    Screen0_HomeButton = leButtonWidget_New();
    Screen0_HomeButton->fn->setPosition(Screen0_HomeButton, 20, 692);
    Screen0_HomeButton->fn->setSize(Screen0_HomeButton, 400, 92);
    Screen0_HomeButton->fn->setScheme(Screen0_HomeButton, &WhiteScheme);
    ...
    Screen0_RecipesButton->fn->setPosition(Screen0_RecipesButton, 440, 692);
    Screen0_RecipesButton->fn->setSize(Screen0_RecipesButton, 400, 92);
    Screen0_RecipesButton->fn->setScheme(Screen0_RecipesButton, &WhiteScheme);
    ...
    Screen0_SettingsButton->fn->setPosition(Screen0_SettingsButton, 860, 692);
    Screen0_SettingsButton->fn->setSize(Screen0_SettingsButton, 400, 92);
    Screen0_SettingsButton->fn->setScheme(Screen0_SettingsButton, &WhiteScheme);
    ...
    // layer 3
    root3 = leWidget_New();
    root3->fn->setSize(root3, 1255, 529);
    ...
    Screen0_FavoriteLabel->fn->setPosition(Screen0_FavoriteLabel, 11, 0);
    Screen0_FavoriteLabel->fn->setSize(Screen0_FavoriteLabel, 121, 25);
    Screen0_FavoriteLabel->fn->setScheme(Screen0_FavoriteLabel, &WhiteScheme);
    ...
    Screen0_RecentsLabel->fn->setPosition(Screen0_RecentsLabel, 11, 269);
    Screen0_RecentsLabel->fn->setScheme(Screen0_RecentsLabel, &WhiteScheme);
    Screen0_RecentsLabel->fn->setBackgroundType(Screen0_RecentsLabel, LE_WIDGET_BACKGROUND_NONE);
    Screen0_RecentsLabel->fn->setString(Screen0_RecentsLabel, (leString*)&string_Recents);
    root3->fn->addChild(root3, (leWidget*)Screen0_RecentsLabel);

    Screen0_RecentRecipesPanel = leWidget_New();
    Screen0_RecentRecipesPanel->fn->setPosition(Screen0_RecentRecipesPanel, 1, 342);
    Screen0_RecentRecipesPanel->fn->setSize(Screen0_RecentRecipesPanel, 1280, 188);
    ...
    Screen0_R1Button->fn->setPosition(Screen0_R1Button, 0, 0);
    Screen0_R1Button->fn->setSize(Screen0_R1Button, 160, 188);
    ...
    Screen0_R1Button->fn->setVAlignment(Screen0_R1Button, LE_VALIGN_TOP);
    Screen0_R1Button->fn->setPressedImage(Screen0_R1Button, (leImage*)&gSalmonS);
    Screen0_R1Button->fn->setReleasedImage(Screen0_R1Button, (leImage*)&gSalmonS);
    ...
    Screen0_R1Label->fn->setPosition(Screen0_R1Label, 7, 163);
    Screen0_R1Label->fn->setSize(Screen0_R1Label, 146, 25);
    Screen0_R1Label->fn->setScheme(Screen0_R1Label, &WhiteScheme);
    ...
    Screen0_R2Button->fn->setPosition(Screen0_R2Button, 182, 0);
    Screen0_R2Button->fn->setSize(Screen0_R2Button, 160, 188);
    ...
    Screen0_R2Button->fn->setVAlignment(Screen0_R2Button, LE_VALIGN_TOP);
    Screen0_R2Button->fn->setPressedImage(Screen0_R2Button, (leImage*)&breakfastBurS);
    Screen0_R2Button->fn->setReleasedImage(Screen0_R2Button, (leImage*)&breakfastBurS);
    ...
    Screen0_R2Label->fn->setPosition(Screen0_R2Label, 7, 163);
    Screen0_R2Label->fn->setSize(Screen0_R2Label, 146, 25);
    Screen0_R2Label->fn->setScheme(Screen0_R2Label, &WhiteScheme);
    ...
    Screen0_R2Label->fn->setString(Screen0_R2Label, (leString*)&string_burrito);
    Screen0_R2Button->fn->addChild(Screen0_R2Button, (leWidget*)Screen0_R2Label);

    Screen0_R3Button = leButtonWidget_New();
    Screen0_R3Button->fn->setPosition(Screen0_R3Button, 364, 0);
    Screen0_R3Button->fn->setSize(Screen0_R3Button, 160, 188);
    ...
    Screen0_R3Button->fn->setVAlignment(Screen0_R3Button, LE_VALIGN_TOP);
    Screen0_R3Button->fn->setPressedImage(Screen0_R3Button, (leImage*)&muffinS);
    Screen0_R3Button->fn->setReleasedImage(Screen0_R3Button, (leImage*)&muffinS);
    ...
    Screen0_R3Label->fn->setPosition(Screen0_R3Label, 7, 163);
    Screen0_R3Label->fn->setSize(Screen0_R3Label, 146, 25);
    Screen0_R3Label->fn->setScheme(Screen0_R3Label, &WhiteScheme);
    ...
    Screen0_R4Button->fn->setPosition(Screen0_R4Button, 546, 0);
    Screen0_R4Button->fn->setSize(Screen0_R4Button, 160, 188);
    ...
    Screen0_R4Button->fn->setVAlignment(Screen0_R4Button, LE_VALIGN_TOP);
    Screen0_R4Button->fn->setPressedImage(Screen0_R4Button, (leImage*)&croisS);
    Screen0_R4Button->fn->setReleasedImage(Screen0_R4Button, (leImage*)&croisS);
    ...
    Screen0_R4Label->fn->setPosition(Screen0_R4Label, 7, 163);
    Screen0_R4Label->fn->setSize(Screen0_R4Label, 146, 25);
    Screen0_R4Label->fn->setScheme(Screen0_R4Label, &WhiteScheme);
    ...
    Screen0_R5Button->fn->setPosition(Screen0_R5Button, 728, 0);
    Screen0_R5Button->fn->setSize(Screen0_R5Button, 160, 188);
    ...
    Screen0_R5Button->fn->setVAlignment(Screen0_R5Button, LE_VALIGN_TOP);
    Screen0_R5Button->fn->setPressedImage(Screen0_R5Button, (leImage*)&pancakeS);
    Screen0_R5Button->fn->setReleasedImage(Screen0_R5Button, (leImage*)&pancakeS);
    ...
    Screen0_R5Label->fn->setPosition(Screen0_R5Label, 7, 163);
    Screen0_R5Label->fn->setSize(Screen0_R5Label, 146, 25);
    Screen0_R5Label->fn->setScheme(Screen0_R5Label, &WhiteScheme);
    ...
    Screen0_R6Button->fn->setPosition(Screen0_R6Button, 910, 0);
    Screen0_R6Button->fn->setSize(Screen0_R6Button, 160, 188);
    ...
    Screen0_R6Button->fn->setVAlignment(Screen0_R6Button, LE_VALIGN_TOP);
    Screen0_R6Button->fn->setPressedImage(Screen0_R6Button, (leImage*)&eggS);
    Screen0_R6Button->fn->setReleasedImage(Screen0_R6Button, (leImage*)&eggS);
    ...
    Screen0_R6Label->fn->setPosition(Screen0_R6Label, 7, 163);
    Screen0_R6Label->fn->setSize(Screen0_R6Label, 146, 25);
    Screen0_R6Label->fn->setScheme(Screen0_R6Label, &WhiteScheme);
    ...
    Screen0_R7Button->fn->setPosition(Screen0_R7Button, 1092, 0);
    Screen0_R7Button->fn->setSize(Screen0_R7Button, 160, 188);
    ...
    Screen0_R7Button->fn->setVAlignment(Screen0_R7Button, LE_VALIGN_TOP);
    Screen0_R7Button->fn->setPressedImage(Screen0_R7Button, (leImage*)&kabobS);
    Screen0_R7Button->fn->setReleasedImage(Screen0_R7Button, (leImage*)&kabobS);
    ...
    Screen0_R7Label->fn->setPosition(Screen0_R7Label, 7, 163);
    Screen0_R7Label->fn->setSize(Screen0_R7Label, 146, 25);
    Screen0_R7Label->fn->setScheme(Screen0_R7Label, &WhiteScheme);
    ...
    // layer 4
    root4 = leWidget_New();
    root4->fn->setSize(root4, 2950, 188);
    ...
    Screen0_RecipesPanel->fn->setSize(Screen0_RecipesPanel, 2950, 188);
    ...
    Screen0_PizzaButton->fn->setPosition(Screen0_PizzaButton, 22, 0);
    Screen0_PizzaButton->fn->setSize(Screen0_PizzaButton, 160, 188);
    ...
    Screen0_PizzaButton->fn->setVAlignment(Screen0_PizzaButton, LE_VALIGN_TOP);
    Screen0_PizzaButton->fn->setPressedImage(Screen0_PizzaButton, (leImage*)&pizzaS);
    Screen0_PizzaButton->fn->setReleasedImage(Screen0_PizzaButton, (leImage*)&pizzaS);
    ...
    Screen0_PizzaLabel->fn->setPosition(Screen0_PizzaLabel, 7, 163);
    Screen0_PizzaLabel->fn->setSize(Screen0_PizzaLabel, 146, 25);
    Screen0_PizzaLabel->fn->setScheme(Screen0_PizzaLabel, &WhiteScheme);
    ...
    Screen0_BurgerButton->fn->setPosition(Screen0_BurgerButton, 204, 0);
    Screen0_BurgerButton->fn->setSize(Screen0_BurgerButton, 160, 188);
    ...
    Screen0_BurgerButton->fn->setVAlignment(Screen0_BurgerButton, LE_VALIGN_TOP);
    Screen0_BurgerButton->fn->setPressedImage(Screen0_BurgerButton, (leImage*)&burgerS);
    Screen0_BurgerButton->fn->setReleasedImage(Screen0_BurgerButton, (leImage*)&burgerS);
    ...
    Screen0_BurgerLabel->fn->setPosition(Screen0_BurgerLabel, 7, 163);
    Screen0_BurgerLabel->fn->setSize(Screen0_BurgerLabel, 146, 25);
    Screen0_BurgerLabel->fn->setScheme(Screen0_BurgerLabel, &WhiteScheme);
    ...
    Screen0_GarlicKButton->fn->setPosition(Screen0_GarlicKButton, 386, 0);
    Screen0_GarlicKButton->fn->setSize(Screen0_GarlicKButton, 160, 188);
    ...
    Screen0_GarlicKButton->fn->setVAlignment(Screen0_GarlicKButton, LE_VALIGN_TOP);
    Screen0_GarlicKButton->fn->setPressedImage(Screen0_GarlicKButton, (leImage*)&garlicS);
    Screen0_GarlicKButton->fn->setReleasedImage(Screen0_GarlicKButton, (leImage*)&garlicS);
    ...
    Screen0_GarlicKLabel->fn->setPosition(Screen0_GarlicKLabel, 7, 162);
    Screen0_GarlicKLabel->fn->setSize(Screen0_GarlicKLabel, 146, 25);
    Screen0_GarlicKLabel->fn->setScheme(Screen0_GarlicKLabel, &WhiteScheme);
    ...
    Screen0_GarlicKLabel->fn->setString(Screen0_GarlicKLabel, (leString*)&string_garlicKnots);
    ...
    Screen0_ChickenButton->fn->setPosition(Screen0_ChickenButton, 568, 0);
    Screen0_ChickenButton->fn->setSize(Screen0_ChickenButton, 160, 188);
    ...
    Screen0_ChickenButton->fn->setVAlignment(Screen0_ChickenButton, LE_VALIGN_TOP);
    Screen0_ChickenButton->fn->setPressedImage(Screen0_ChickenButton, (leImage*)&wChickenS);
    Screen0_ChickenButton->fn->setReleasedImage(Screen0_ChickenButton, (leImage*)&wChickenS);
    ...
    Screen0_ChickenLabel->fn->setPosition(Screen0_ChickenLabel, 7, 163);
    Screen0_ChickenLabel->fn->setSize(Screen0_ChickenLabel, 146, 25);
    Screen0_ChickenLabel->fn->setScheme(Screen0_ChickenLabel, &WhiteScheme);
    ...
    Screen0_KabobButton->fn->setPosition(Screen0_KabobButton, 750, 0);
    Screen0_KabobButton->fn->setSize(Screen0_KabobButton, 160, 188);
    ...
    Screen0_KabobButton->fn->setVAlignment(Screen0_KabobButton, LE_VALIGN_TOP);
    Screen0_KabobButton->fn->setPressedImage(Screen0_KabobButton, (leImage*)&kabobS);
    Screen0_KabobButton->fn->setReleasedImage(Screen0_KabobButton, (leImage*)&kabobS);
    ...
    Screen0_KabobLabel->fn->setPosition(Screen0_KabobLabel, 7, 163);
    Screen0_KabobLabel->fn->setSize(Screen0_KabobLabel, 146, 25);
    Screen0_KabobLabel->fn->setScheme(Screen0_KabobLabel, &WhiteScheme);
    ...
    Screen0_SalmonSButton->fn->setPosition(Screen0_SalmonSButton, 932, 0);
    Screen0_SalmonSButton->fn->setSize(Screen0_SalmonSButton, 160, 188);
    ...
    Screen0_SalmonSButton->fn->setVAlignment(Screen0_SalmonSButton, LE_VALIGN_TOP);
    Screen0_SalmonSButton->fn->setPressedImage(Screen0_SalmonSButton, (leImage*)&sSalmonS);
    Screen0_SalmonSButton->fn->setReleasedImage(Screen0_SalmonSButton, (leImage*)&sSalmonS);
    ...
    Screen0_SalmonSLabel->fn->setPosition(Screen0_SalmonSLabel, 7, 163);
    Screen0_SalmonSLabel->fn->setSize(Screen0_SalmonSLabel, 146, 25);
    Screen0_SalmonSLabel->fn->setScheme(Screen0_SalmonSLabel, &WhiteScheme);
    ...
    Screen0_SalmonGButton->fn->setPosition(Screen0_SalmonGButton, 1114, 0);
    Screen0_SalmonGButton->fn->setSize(Screen0_SalmonGButton, 160, 188);
    ...
    Screen0_SalmonGButton->fn->setPressedImage(Screen0_SalmonGButton, (leImage*)&gSalmonS);
    Screen0_SalmonGButton->fn->setReleasedImage(Screen0_SalmonGButton, (leImage*)&gSalmonS);
    ...
    Screen0_SalmonGLabel->fn->setPosition(Screen0_SalmonGLabel, 7, 163);
    Screen0_SalmonGLabel->fn->setSize(Screen0_SalmonGLabel, 146, 25);
    Screen0_SalmonGLabel->fn->setScheme(Screen0_SalmonGLabel, &WhiteScheme);
    ...
    Screen0_BaconButton->fn->setPosition(Screen0_BaconButton, 1296, 0);
    Screen0_BaconButton->fn->setSize(Screen0_BaconButton, 160, 188);
    ...
    Screen0_BaconButton->fn->setVAlignment(Screen0_BaconButton, LE_VALIGN_TOP);
    ...
    Screen0_BaconLabel->fn->setPosition(Screen0_BaconLabel, 7, 163);
    Screen0_BaconLabel->fn->setSize(Screen0_BaconLabel, 146, 25);
    Screen0_BaconLabel->fn->setScheme(Screen0_BaconLabel, &WhiteScheme);
    ...
    Screen0_BurritoButton->fn->setPosition(Screen0_BurritoButton, 1478, 0);
    Screen0_BurritoButton->fn->setSize(Screen0_BurritoButton, 160, 188);
    ...
    Screen0_BurritoButton->fn->setVAlignment(Screen0_BurritoButton, LE_VALIGN_TOP);
    Screen0_BurritoButton->fn->setPressedImage(Screen0_BurritoButton, (leImage*)&breakfastBurS);
    Screen0_BurritoButton->fn->setReleasedImage(Screen0_BurritoButton, (leImage*)&breakfastBurS);
    ...
    Screen0_BurritoLabel->fn->setPosition(Screen0_BurritoLabel, 7, 163);
    Screen0_BurritoLabel->fn->setSize(Screen0_BurritoLabel, 146, 25);
    Screen0_BurritoLabel->fn->setScheme(Screen0_BurritoLabel, &WhiteScheme);
    Screen0_BurritoLabel->fn->setBackgroundType(Screen0_BurritoLabel, LE_WIDGET_BACKGROUND_NONE);
    Screen0_BurritoLabel->fn->setString(Screen0_BurritoLabel, (leString*)&string_burrito);
    ...
    Screen0_CroissantButton->fn->setPosition(Screen0_CroissantButton, 1660, 0);
    Screen0_CroissantButton->fn->setSize(Screen0_CroissantButton, 160, 188);
    ...
    Screen0_CroissantButton->fn->setVAlignment(Screen0_CroissantButton, LE_VALIGN_TOP);
    Screen0_CroissantButton->fn->setPressedImage(Screen0_CroissantButton, (leImage*)&croisS);
    Screen0_CroissantButton->fn->setReleasedImage(Screen0_CroissantButton, (leImage*)&croisS);
    ...
    Screen0_CroissantLabel->fn->setPosition(Screen0_CroissantLabel, 7, 163);
    Screen0_CroissantLabel->fn->setSize(Screen0_CroissantLabel, 146, 25);
    Screen0_CroissantLabel->fn->setScheme(Screen0_CroissantLabel, &WhiteScheme);
    ...
    Screen0_EggToastButton->fn->setPosition(Screen0_EggToastButton, 1842, 0);
    Screen0_EggToastButton->fn->setSize(Screen0_EggToastButton, 160, 188);
    ...
    Screen0_EggToastButton->fn->setVAlignment(Screen0_EggToastButton, LE_VALIGN_TOP);
    Screen0_EggToastButton->fn->setPressedImage(Screen0_EggToastButton, (leImage*)&eggS);
    Screen0_EggToastButton->fn->setReleasedImage(Screen0_EggToastButton, (leImage*)&eggS);
    ...
    Screen0_EggToastLabel->fn->setPosition(Screen0_EggToastLabel, 7, 163);
    Screen0_EggToastLabel->fn->setSize(Screen0_EggToastLabel, 146, 25);
    Screen0_EggToastLabel->fn->setScheme(Screen0_EggToastLabel, &WhiteScheme);
    ...
    Screen0_FToastButton->fn->setPosition(Screen0_FToastButton, 2024, 0);
    Screen0_FToastButton->fn->setSize(Screen0_FToastButton, 160, 188);
    ...
    Screen0_FToastButton->fn->setVAlignment(Screen0_FToastButton, LE_VALIGN_TOP);
    Screen0_FToastButton->fn->setPressedImage(Screen0_FToastButton, (leImage*)&fToastS);
    Screen0_FToastButton->fn->setReleasedImage(Screen0_FToastButton, (leImage*)&fToastS);
    ...
    Screen0_FToastLabel->fn->setPosition(Screen0_FToastLabel, 7, 163);
    Screen0_FToastLabel->fn->setSize(Screen0_FToastLabel, 146, 25);
    Screen0_FToastLabel->fn->setScheme(Screen0_FToastLabel, &WhiteScheme);
    ...
    Screen0_FToastLabel->fn->setString(Screen0_FToastLabel, (leString*)&string_fToast);
    ...
    Screen0_MuffinButton->fn->setPosition(Screen0_MuffinButton, 2206, 0);
    Screen0_MuffinButton->fn->setSize(Screen0_MuffinButton, 160, 188);
    ...
    Screen0_MuffinButton->fn->setVAlignment(Screen0_MuffinButton, LE_VALIGN_TOP);
    Screen0_MuffinButton->fn->setPressedImage(Screen0_MuffinButton, (leImage*)&muffinS);
    Screen0_MuffinButton->fn->setReleasedImage(Screen0_MuffinButton, (leImage*)&muffinS);
    ...
    Screen0_MuffinLabel->fn->setPosition(Screen0_MuffinLabel, 7, 163);
    Screen0_MuffinLabel->fn->setSize(Screen0_MuffinLabel, 146, 25);
    Screen0_MuffinLabel->fn->setScheme(Screen0_MuffinLabel, &WhiteScheme);
    ...
    Screen0_OmletteButton->fn->setPosition(Screen0_OmletteButton, 2388, 0);
    Screen0_OmletteButton->fn->setSize(Screen0_OmletteButton, 160, 188);
    ...
    Screen0_OmletteButton->fn->setVAlignment(Screen0_OmletteButton, LE_VALIGN_TOP);
    Screen0_OmletteButton->fn->setPressedImage(Screen0_OmletteButton, (leImage*)&omletteS);
    Screen0_OmletteButton->fn->setReleasedImage(Screen0_OmletteButton, (leImage*)&omletteS);
    ...
    Screen0_OmletteLabel->fn->setPosition(Screen0_OmletteLabel, 7, 163);
    Screen0_OmletteLabel->fn->setSize(Screen0_OmletteLabel, 146, 25);
    Screen0_OmletteLabel->fn->setScheme(Screen0_OmletteLabel, &WhiteScheme);
    ...
    Screen0_PancakeButton->fn->setPosition(Screen0_PancakeButton, 2570, 0);
    Screen0_PancakeButton->fn->setSize(Screen0_PancakeButton, 160, 188);
    ...
    Screen0_PancakeButton->fn->setVAlignment(Screen0_PancakeButton, LE_VALIGN_TOP);
    Screen0_PancakeButton->fn->setPressedImage(Screen0_PancakeButton, (leImage*)&pancakeS);
    Screen0_PancakeButton->fn->setReleasedImage(Screen0_PancakeButton, (leImage*)&pancakeS);
    ...
    Screen0_PancakeLabel->fn->setPosition(Screen0_PancakeLabel, 7, 163);
    Screen0_PancakeLabel->fn->setSize(Screen0_PancakeLabel, 146, 25);
    Screen0_PancakeLabel->fn->setScheme(Screen0_PancakeLabel, &WhiteScheme);
    ...
    Screen0_QuesaButton->fn->setPosition(Screen0_QuesaButton, 2752, 0);
    Screen0_QuesaButton->fn->setSize(Screen0_QuesaButton, 160, 188);
    ...
    Screen0_QuesaButton->fn->setVAlignment(Screen0_QuesaButton, LE_VALIGN_TOP);
    Screen0_QuesaButton->fn->setPressedImage(Screen0_QuesaButton, (leImage*)&quesoS);
    Screen0_QuesaButton->fn->setReleasedImage(Screen0_QuesaButton, (leImage*)&quesoS);
    ...
    Screen0_QuesaLabel->fn->setPosition(Screen0_QuesaLabel, 7, 163);
    Screen0_QuesaLabel->fn->setSize(Screen0_QuesaLabel, 146, 25);
    Screen0_QuesaLabel->fn->setScheme(Screen0_QuesaLabel, &WhiteScheme);
    ...
    // layer 5
    root5 = leWidget_New();
    root5->fn->setSize(root5, 1071, 557);
    ...
    Screen0_CookingLabel->fn->setSize(Screen0_CookingLabel, 280, 41);
    Screen0_CookingLabel->fn->setScheme(Screen0_CookingLabel, &WhiteScheme);
    ...
    Screen0_CookingLabel->fn->setVAlignment(Screen0_CookingLabel, LE_VALIGN_TOP);
    Screen0_CookingLabel->fn->setMargins(Screen0_CookingLabel, 4, 0, 4, 4);
    ...
    Screen0_CookingImage->fn->setSize(Screen0_CookingImage, 280, 335);
    ...
    Screen0_CookingImage->fn->setVAlignment(Screen0_CookingImage, LE_VALIGN_TOP);
    root5->fn->addChild(root5, (leWidget*)Screen0_CookingImage);

    Screen0_CookingStg1Image = leImageWidget_New();
    Screen0_CookingStg1Image->fn->setPosition(Screen0_CookingStg1Image, 722, 41);
    Screen0_CookingStg1Image->fn->setSize(Screen0_CookingStg1Image, 286, 58);
    Screen0_CookingStg1Image->fn->setEnabled(Screen0_CookingStg1Image, LE_FALSE);
    ...
    Screen0_CookingStg2Image->fn->setPosition(Screen0_CookingStg2Image, 722, 138);
    Screen0_CookingStg2Image->fn->setSize(Screen0_CookingStg2Image, 286, 58);
    Screen0_CookingStg2Image->fn->setEnabled(Screen0_CookingStg2Image, LE_FALSE);
    ...
    Screen0_CookingStg3Image->fn->setPosition(Screen0_CookingStg3Image, 722, 235);
    Screen0_CookingStg3Image->fn->setSize(Screen0_CookingStg3Image, 286, 58);
    Screen0_CookingStg3Image->fn->setEnabled(Screen0_CookingStg3Image, LE_FALSE);
    ...
    Screen0_BackButton->fn->setPosition(Screen0_BackButton, 0, 0);
    Screen0_BackButton->fn->setSize(Screen0_BackButton, 132, 53);
    ...
    Screen0_BackButton->fn->setPressedImage(Screen0_BackButton, (leImage*)&backBttn);
    Screen0_BackButton->fn->setReleasedImage(Screen0_BackButton, (leImage*)&backBttn);
    ...
    Screen0_AddFavButton->fn->setPosition(Screen0_AddFavButton, 245, 377);
    Screen0_AddFavButton->fn->setSize(Screen0_AddFavButton, 215, 50);
    ...
    Screen0_AddFavButton->fn->setPressedImage(Screen0_AddFavButton, (leImage*)&FavBttn);
    Screen0_AddFavButton->fn->setReleasedImage(Screen0_AddFavButton, (leImage*)&FavBttn);
    root5->fn->addChild(root5, (leWidget*)Screen0_AddFavButton);

    Screen0_CookStartButton = leButtonWidget_New();
    Screen0_CookStartButton->fn->setPosition(Screen0_CookStartButton, 722, 332);
    Screen0_CookStartButton->fn->setSize(Screen0_CookStartButton, 308, 77);
    ...
    Screen0_CookTimeLabel->fn->setPosition(Screen0_CookTimeLabel, 733, 117);
    Screen0_CookTimeLabel->fn->setSize(Screen0_CookTimeLabel, 301, 105);
    ...
    Screen0_CookTimeLabel->fn->setScheme(Screen0_CookTimeLabel, &WhiteScheme);
    ...
    Screen0_GreenCheckImage->fn->setPosition(Screen0_GreenCheckImage, 249, 234);
    ...
    Screen0_GreenCheckImage->fn->setImage(Screen0_GreenCheckImage, (leImage*)&greenCheck);
    root5->fn->addChild(root5, (leWidget*)Screen0_GreenCheckImage);

    Screen0_foodCLabel = leLabelWidget_New();
    Screen0_foodCLabel->fn->setPosition(Screen0_foodCLabel, 660, 22);
    Screen0_foodCLabel->fn->setSize(Screen0_foodCLabel, 412, 203);
    Screen0_foodCLabel->fn->setEnabled(Screen0_foodCLabel, LE_FALSE);
    Screen0_foodCLabel->fn->setVisible(Screen0_foodCLabel, LE_FALSE);
    Screen0_foodCLabel->fn->setScheme(Screen0_foodCLabel, &OrangeScheme);
    ...
    Screen0_foodCLabel->fn->setVAlignment(Screen0_foodCLabel, LE_VALIGN_TOP);
    Screen0_foodCLabel->fn->setMargins(Screen0_foodCLabel, 0, 0, 0, 0);
    ...
    Screen0_Notice1Label->fn->setPosition(Screen0_Notice1Label, 660, 232);
    Screen0_Notice1Label->fn->setSize(Screen0_Notice1Label, 412, 98);
    ...
    Screen0_Notice1Label->fn->setScheme(Screen0_Notice1Label, &WhiteScheme);
    ...
    Screen0_Notice1Label->fn->setVAlignment(Screen0_Notice1Label, LE_VALIGN_TOP);
    ...
    Screen0_RoundGlowRingImage->fn->setPosition(Screen0_RoundGlowRingImage, 47, 57);
    Screen0_RoundGlowRingImage->fn->setSize(Screen0_RoundGlowRingImage, 530, 498);
    ...
    Screen0_CookProgressArc->fn->setPosition(Screen0_CookProgressArc, 71, 70);
    Screen0_CookProgressArc->fn->setSize(Screen0_CookProgressArc, 482, 464);
    ...
    Screen0_CookProgressArc->fn->setScheme(Screen0_CookProgressArc, &OrangeScheme);
    Screen0_CookProgressArc->fn->setRadius(Screen0_CookProgressArc, 202);
    ...
    Screen0_CookProgressArc->fn->setThickness(Screen0_CookProgressArc, 15);
    ...
    Screen0_CancelConfirmationPanel->fn->setPosition(Screen0_CancelConfirmationPanel, 269, 111);
    Screen0_CancelConfirmationPanel->fn->setSize(Screen0_CancelConfirmationPanel, 677, 203);
    ...
    Screen0_CancelConfirmImage->fn->setSize(Screen0_CancelConfirmImage, 677, 203);
    ...
    Screen0_BackCancelButton->fn->setPosition(Screen0_BackCancelButton, 80, 111);
    Screen0_BackCancelButton->fn->setSize(Screen0_BackCancelButton, 251, 49);
    Screen0_BackCancelButton->fn->setScheme(Screen0_BackCancelButton, &WhiteScheme);
    ...
    Screen0_BackCancelButton->fn->setPressedImage(Screen0_BackCancelButton, (leImage*)&backCancel);
    Screen0_BackCancelButton->fn->setReleasedImage(Screen0_BackCancelButton, (leImage*)&backCancel);
    ...
    Screen0_YesCancelButton->fn->setPosition(Screen0_YesCancelButton, 360, 111);
    Screen0_YesCancelButton->fn->setSize(Screen0_YesCancelButton, 251, 49);
    ...
    Screen0_YesCancelButton->fn->setPressedImage(Screen0_YesCancelButton, (leImage*)&YesCancel);
    Screen0_YesCancelButton->fn->setReleasedImage(Screen0_YesCancelButton, (leImage*)&YesCancel);
    ...
    Screen0_CancelNoticeLabel->fn->setPosition(Screen0_CancelNoticeLabel, 80, 47);
    Screen0_CancelNoticeLabel->fn->setSize(Screen0_CancelNoticeLabel, 517, 55);
    Screen0_CancelNoticeLabel->fn->setScheme(Screen0_CancelNoticeLabel, &WhiteScheme);
    ...
    // layer 6
    root6 = leWidget_New();
    root6->fn->setSize(root6, 1218, 400);
    ...
    Screen0_setingButtonsPanel = leWidget_New();
    Screen0_setingButtonsPanel->fn->setPosition(Screen0_setingButtonsPanel, 0, 0);
    Screen0_setingButtonsPanel->fn->setSize(Screen0_setingButtonsPanel, 1218, 400);
    Screen0_setingButtonsPanel->fn->setEnabled(Screen0_setingButtonsPanel, LE_FALSE);
    Screen0_setingButtonsPanel->fn->setBackgroundType(Screen0_setingButtonsPanel, LE_WIDGET_BACKGROUND_NONE);
    root6->fn->addChild(root6, (leWidget*)Screen0_setingButtonsPanel);

    Screen0_USBSettingImage = leImageWidget_New();
    Screen0_USBSettingImage->fn->setPosition(Screen0_USBSettingImage, 0, 0);
    Screen0_USBSettingImage->fn->setSize(Screen0_USBSettingImage, 389, 400);
    ...
    Screen0_USBSettingImage->fn->setImage(Screen0_USBSettingImage, (leImage*)&GreyBox4bttn);
    Screen0_setingButtonsPanel->fn->addChild(Screen0_setingButtonsPanel, (leWidget*)Screen0_USBSettingImage);

    Screen0_USBLogoImage = leImageWidget_New();
    Screen0_USBLogoImage->fn->setPosition(Screen0_USBLogoImage, 154, 140);
    Screen0_USBLogoImage->fn->setSize(Screen0_USBLogoImage, 80, 80);
    ...
    Screen0_USBLabel->fn->setPosition(Screen0_USBLabel, 0, 220);
    Screen0_USBLabel->fn->setSize(Screen0_USBLabel, 389, 85);
    Screen0_USBLabel->fn->setScheme(Screen0_USBLabel, &WhiteScheme);
    ...
    Screen0_USBLabel->fn->setString(Screen0_USBLabel, (leString*)&string_usbSetting);
    ...
    Screen0_USBSettingButton->fn->setSize(Screen0_USBSettingButton, 389, 400);
    ...
    Screen0_FirmwareSettingImage->fn->setPosition(Screen0_FirmwareSettingImage, 415, 0);
    Screen0_FirmwareSettingImage->fn->setSize(Screen0_FirmwareSettingImage, 389, 400);
    ...
    Screen0_FirmwareSettingImage->fn->setImage(Screen0_FirmwareSettingImage, (leImage*)&GreyBox4bttn);
    Screen0_setingButtonsPanel->fn->addChild(Screen0_setingButtonsPanel, (leWidget*)Screen0_FirmwareSettingImage);

    Screen0_FirmwareLogoImage = leImageWidget_New();
    Screen0_FirmwareLogoImage->fn->setPosition(Screen0_FirmwareLogoImage, 154, 140);
    Screen0_FirmwareLogoImage->fn->setSize(Screen0_FirmwareLogoImage, 80, 80);
    ...
    Screen0_FirmwareLabel->fn->setPosition(Screen0_FirmwareLabel, 0, 220);
    Screen0_FirmwareLabel->fn->setSize(Screen0_FirmwareLabel, 389, 85);
    Screen0_FirmwareLabel->fn->setScheme(Screen0_FirmwareLabel, &WhiteScheme);
    ...
    Screen0_FirmwareLabel->fn->setString(Screen0_FirmwareLabel, (leString*)&string_firmwareSetting);
    ...
    Screen0_FirmwareSettingButton->fn->setSize(Screen0_FirmwareSettingButton, 389, 400);
    ...
    Screen0_WifiSettingImage->fn->setPosition(Screen0_WifiSettingImage, 830, 0);
    Screen0_WifiSettingImage->fn->setSize(Screen0_WifiSettingImage, 389, 400);
    ...
    Screen0_WifiSettingImage->fn->setImage(Screen0_WifiSettingImage, (leImage*)&GreyBox4bttn);
    Screen0_setingButtonsPanel->fn->addChild(Screen0_setingButtonsPanel, (leWidget*)Screen0_WifiSettingImage);

    Screen0_WifiLogoImage = leImageWidget_New();
    Screen0_WifiLogoImage->fn->setPosition(Screen0_WifiLogoImage, 154, 140);
    Screen0_WifiLogoImage->fn->setSize(Screen0_WifiLogoImage, 80, 80);
    ...
    Screen0_WifiLabel->fn->setPosition(Screen0_WifiLabel, 0, 220);
    Screen0_WifiLabel->fn->setSize(Screen0_WifiLabel, 389, 85);
    Screen0_WifiLabel->fn->setScheme(Screen0_WifiLabel, &WhiteScheme);
    ...
    Screen0_WifiLabel->fn->setString(Screen0_WifiLabel, (leString*)&string_wifiSetting);
    ...
    Screen0_WifiSettingButton->fn->setSize(Screen0_WifiSettingButton, 389, 400);
    ...
    Screen0_WifiSetupPanel->fn->setSize(Screen0_WifiSetupPanel, 1218, 400);
    ...
    root6->fn->addChild(root6, (leWidget*)Screen0_WifiSetupPanel);

    Screen0_wifiBackButton = leButtonWidget_New();
    Screen0_wifiBackButton->fn->setPosition(Screen0_wifiBackButton, 0, 0);
    Screen0_wifiBackButton->fn->setSize(Screen0_wifiBackButton, 132, 53);
    Screen0_wifiBackButton->fn->setBackgroundType(Screen0_wifiBackButton, LE_WIDGET_BACKGROUND_NONE);
    Screen0_wifiBackButton->fn->setBorderType(Screen0_wifiBackButton, LE_WIDGET_BORDER_NONE);
    Screen0_wifiBackButton->fn->setPressedImage(Screen0_wifiBackButton, (leImage*)&backBttn);
    Screen0_wifiBackButton->fn->setReleasedImage(Screen0_wifiBackButton, (leImage*)&backBttn);
    Screen0_wifiBackButton->fn->setReleasedEventCallback(Screen0_wifiBackButton, event_Screen0_wifiBackButton_OnReleased);
    Screen0_WifiSetupPanel->fn->addChild(Screen0_WifiSetupPanel, (leWidget*)Screen0_wifiBackButton);

    Screen0_WifiSetupLabel = leLabelWidget_New();
    Screen0_WifiSetupLabel->fn->setPosition(Screen0_WifiSetupLabel, 382, 0);
    Screen0_WifiSetupLabel->fn->setSize(Screen0_WifiSetupLabel, 162, 46);
    Screen0_WifiSetupLabel->fn->setScheme(Screen0_WifiSetupLabel, &WhiteScheme);
    Screen0_WifiSetupLabel->fn->setBackgroundType(Screen0_WifiSetupLabel, LE_WIDGET_BACKGROUND_NONE);
    Screen0_WifiSetupLabel->fn->setVAlignment(Screen0_WifiSetupLabel, LE_VALIGN_TOP);
    ...
    Screen0_ScanNwButton->fn->setPosition(Screen0_ScanNwButton, 655, 0);
    Screen0_ScanNwButton->fn->setSize(Screen0_ScanNwButton, 195, 48);
    ...
    Screen0_OtherNWsLabel->fn->setPosition(Screen0_OtherNWsLabel, 655, 82);
    Screen0_OtherNWsLabel->fn->setSize(Screen0_OtherNWsLabel, 216, 25);
    Screen0_OtherNWsLabel->fn->setScheme(Screen0_OtherNWsLabel, &WhiteScheme);
    ...
    Screen0_wifiConnectedImage->fn->setPosition(Screen0_wifiConnectedImage, 382, 82);
    Screen0_wifiConnectedImage->fn->setSize(Screen0_wifiConnectedImage, 154, 64);
    ...
    Screen0_wifi1Button->fn->setPosition(Screen0_wifi1Button, 656, 132);
    Screen0_wifi1Button->fn->setSize(Screen0_wifi1Button, 243, 48);
    Screen0_wifi1Button->fn->setScheme(Screen0_wifi1Button, &WhiteScheme);
    ...
    Screen0_wifi2Button->fn->setPosition(Screen0_wifi2Button, 656, 205);
    Screen0_wifi2Button->fn->setSize(Screen0_wifi2Button, 243, 48);
    Screen0_wifi2Button->fn->setScheme(Screen0_wifi2Button, &WhiteScheme);
    ...
    // layer 7
    root7 = leWidget_New();
    root7->fn->setSize(root7, 1280, 800);
    ...
    Screen0_SettingsTransparentPanel->fn->setPosition(Screen0_SettingsTransparentPanel, 3, 2);
    Screen0_SettingsTransparentPanel->fn->setSize(Screen0_SettingsTransparentPanel, 1280, 800);
    Screen0_SettingsTransparentPanel->fn->setAlphaEnabled(Screen0_SettingsTransparentPanel, LE_TRUE);
    Screen0_SettingsTransparentPanel->fn->setAlphaAmount(Screen0_SettingsTransparentPanel, 200);
    Screen0_SettingsTransparentPanel->fn->setEnabled(Screen0_SettingsTransparentPanel, LE_FALSE);
    Screen0_SettingsTransparentPanel->fn->setScheme(Screen0_SettingsTransparentPanel, &BlackScheme);
    root7->fn->addChild(root7, (leWidget*)Screen0_SettingsTransparentPanel);

    Screen0_keyboardPanel = leWidget_New();
    Screen0_keyboardPanel->fn->setPosition(Screen0_keyboardPanel, 0, 395);
    Screen0_keyboardPanel->fn->setSize(Screen0_keyboardPanel, 1280, 405);
    ...
    Screen0_qRowKeyPad->fn->setPosition(Screen0_qRowKeyPad, 15, 15);
    Screen0_qRowKeyPad->fn->setSize(Screen0_qRowKeyPad, 1139, 85);
    ...
    Screen0_aRowKeyPad->fn->setPosition(Screen0_aRowKeyPad, 72, 115);
    Screen0_aRowKeyPad->fn->setSize(Screen0_aRowKeyPad, 1023, 78);
    ...
    Screen0_zRowKeyPad->fn->setPosition(Screen0_zRowKeyPad, 128, 208);
    Screen0_zRowKeyPad->fn->setSize(Screen0_zRowKeyPad, 1023, 79);
    ...
    Screen0_keypadImage->fn->setPosition(Screen0_keypadImage, 0, 0);
    Screen0_keypadImage->fn->setSize(Screen0_keypadImage, 1280, 405);
    ...
    Screen0_enterKeyButton->fn->setPosition(Screen0_enterKeyButton, 1104, 117);
    Screen0_enterKeyButton->fn->setSize(Screen0_enterKeyButton, 154, 79);
    ...
    Screen0_ShiftKey1Button->fn->setPosition(Screen0_ShiftKey1Button, 14, 209);
    Screen0_ShiftKey1Button->fn->setSize(Screen0_ShiftKey1Button, 100, 78);
    ...
    Screen0_ShiftKey2Button->fn->setPosition(Screen0_ShiftKey2Button, 1160, 211);
    Screen0_ShiftKey2Button->fn->setSize(Screen0_ShiftKey2Button, 104, 79);
    ...
    Screen0_CommaKeyButton = leButtonWidget_New();
    Screen0_CommaKeyButton->fn->setPosition(Screen0_CommaKeyButton, 125, 306);
    Screen0_CommaKeyButton->fn->setSize(Screen0_CommaKeyButton, 100, 78);
    Screen0_CommaKeyButton->fn->setBackgroundType(Screen0_CommaKeyButton, LE_WIDGET_BACKGROUND_NONE);
    Screen0_CommaKeyButton->fn->setBorderType(Screen0_CommaKeyButton, LE_WIDGET_BORDER_NONE);
    Screen0_CommaKeyButton->fn->setReleasedEventCallback(Screen0_CommaKeyButton, event_Screen0_CommaKeyButton_OnReleased);
    Screen0_keyboardPanel->fn->addChild(Screen0_keyboardPanel, (leWidget*)Screen0_CommaKeyButton);

    Screen0_SpaceKeyButton = leButtonWidget_New();
    Screen0_SpaceKeyButton->fn->setPosition(Screen0_SpaceKeyButton, 242, 307);
    Screen0_SpaceKeyButton->fn->setSize(Screen0_SpaceKeyButton, 787, 73);
    ...
    Screen0_PeriodKeyButton->fn->setPosition(Screen0_PeriodKeyButton, 1048, 305);
    Screen0_PeriodKeyButton->fn->setSize(Screen0_PeriodKeyButton, 100, 76);
    ...
    Screen0_BackSpaceButton->fn->setPosition(Screen0_BackSpaceButton, 1160, 19);
    Screen0_BackSpaceButton->fn->setSize(Screen0_BackSpaceButton, 100, 77);
    ...
    Screen0_AdminPwdPanel->fn->setPosition(Screen0_AdminPwdPanel, 404, 82);
    Screen0_AdminPwdPanel->fn->setSize(Screen0_AdminPwdPanel, 524, 270);
    Screen0_AdminPwdPanel->fn->setEnabled(Screen0_AdminPwdPanel, LE_FALSE);
    Screen0_AdminPwdPanel->fn->setScheme(Screen0_AdminPwdPanel, &GreyScheme);
    root7->fn->addChild(root7, (leWidget*)Screen0_AdminPwdPanel);

    Screen0_AdminPwdCancelButton = leButtonWidget_New();
    Screen0_AdminPwdCancelButton->fn->setPosition(Screen0_AdminPwdCancelButton, 80, 186);
    Screen0_AdminPwdCancelButton->fn->setSize(Screen0_AdminPwdCancelButton, 163, 50);
    Screen0_AdminPwdCancelButton->fn->setScheme(Screen0_AdminPwdCancelButton, &WhiteScheme);
    ...
    Screen0_AdminPwdCancelButton->fn->setString(Screen0_AdminPwdCancelButton, (leString*)&string_cancelSetting);
    Screen0_AdminPwdCancelButton->fn->setPressedImage(Screen0_AdminPwdCancelButton, (leImage*)&SettingsCancel);
    Screen0_AdminPwdCancelButton->fn->setReleasedImage(Screen0_AdminPwdCancelButton, (leImage*)&SettingsCancel);
    ...
    Screen0_AdminPwdDoneButton->fn->setPosition(Screen0_AdminPwdDoneButton, 274, 186);
    Screen0_AdminPwdDoneButton->fn->setSize(Screen0_AdminPwdDoneButton, 163, 50);
    ...
    Screen0_AdminPwdDoneButton->fn->setString(Screen0_AdminPwdDoneButton, (leString*)&string_doneSetting);
    Screen0_AdminPwdDoneButton->fn->setPressedImage(Screen0_AdminPwdDoneButton, (leImage*)&SettingYes);
    Screen0_AdminPwdDoneButton->fn->setReleasedImage(Screen0_AdminPwdDoneButton, (leImage*)&SettingYes);
    ...
    Screen0_AdminPwdLabel->fn->setPosition(Screen0_AdminPwdLabel, 80, 40);
    Screen0_AdminPwdLabel->fn->setSize(Screen0_AdminPwdLabel, 364, 71);
    Screen0_AdminPwdLabel->fn->setScheme(Screen0_AdminPwdLabel, &WhiteScheme);
    Screen0_AdminPwdLabel->fn->setBackgroundType(Screen0_AdminPwdLabel, LE_WIDGET_BACKGROUND_NONE);
    Screen0_AdminPwdLabel->fn->setVAlignment(Screen0_AdminPwdLabel, LE_VALIGN_TOP);
    ...
    Screen0_AdminPwdImage->fn->setPosition(Screen0_AdminPwdImage, 80, 122);
    Screen0_AdminPwdImage->fn->setSize(Screen0_AdminPwdImage, 362, 40);
    ...
    Screen0_AdminPwdImage->fn->setImage(Screen0_AdminPwdImage, (leImage*)&SearchField);
    ...
    Screen0_AdminPWDTextField->fn->setPosition(Screen0_AdminPWDTextField, 80, 122);
    Screen0_AdminPWDTextField->fn->setSize(Screen0_AdminPWDTextField, 362, 40);
    Screen0_AdminPWDTextField->fn->setScheme(Screen0_AdminPWDTextField, &WhiteScheme);
    ...
    Screen0_SettingsBoxImage->fn->setPosition(Screen0_SettingsBoxImage, 354, 200);
    Screen0_SettingsBoxImage->fn->setSize(Screen0_SettingsBoxImage, 573, 400);
    ...
    Screen0_SettingsBoxImage->fn->setImage(Screen0_SettingsBoxImage, (leImage*)&LargeSettingsBox);
    root7->fn->addChild(root7, (leWidget*)Screen0_SettingsBoxImage);

    Screen0_SettingUpdateImage = leImageWidget_New();
    Screen0_SettingUpdateImage->fn->setPosition(Screen0_SettingUpdateImage, 246, 80);
    Screen0_SettingUpdateImage->fn->setSize(Screen0_SettingUpdateImage, 80, 80);
    ...
    Screen0_SettingUpdateLabel->fn->setPosition(Screen0_SettingUpdateLabel, 120, 190);
    Screen0_SettingUpdateLabel->fn->setSize(Screen0_SettingUpdateLabel, 333, 90);
    Screen0_SettingUpdateLabel->fn->setScheme(Screen0_SettingUpdateLabel, &WhiteScheme);
    ...
    Screen0_SettingUpdateLabel->fn->setVAlignment(Screen0_SettingUpdateLabel, LE_VALIGN_TOP);
    ...
    Screen0_SettingNApplyButton->fn->setPosition(Screen0_SettingNApplyButton, 100, 290);
    Screen0_SettingNApplyButton->fn->setSize(Screen0_SettingNApplyButton, 163, 50);
    ...
    Screen0_SettingNApplyButton->fn->setScheme(Screen0_SettingNApplyButton, &WhiteScheme);
    ...
    Screen0_SettingNApplyButton->fn->setPressedImage(Screen0_SettingNApplyButton, (leImage*)&SettingsCancel);
    Screen0_SettingNApplyButton->fn->setReleasedImage(Screen0_SettingNApplyButton, (leImage*)&SettingsCancel);
    ...
    Screen0_SettingApplyButton->fn->setPosition(Screen0_SettingApplyButton, 318, 290);
    Screen0_SettingApplyButton->fn->setSize(Screen0_SettingApplyButton, 163, 50);
    ...
    Screen0_SettingApplyButton->fn->setPressedImage(Screen0_SettingApplyButton, (leImage*)&SettingYes);
    Screen0_SettingApplyButton->fn->setReleasedImage(Screen0_SettingApplyButton, (leImage*)&SettingYes);
    ...
    Screen0_USBDotsImage->fn->setPosition(Screen0_USBDotsImage, 240, 166);
    Screen0_USBDotsImage->fn->setSize(Screen0_USBDotsImage, 92, 20);
...
void screenHide_Screen0(void)
{
    ...
    Screen0_setingButtonsPanel = NULL;
